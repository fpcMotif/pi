...
describe("isSafeCommand", () => {
	describe("safe commands", () => {
		...
		it("allows Bun read commands", () => {
			expect(isSafeCommand("bun list")).toBe(true);
			expect(isSafeCommand("bun info react")).toBe(true);
			expect(isSafeCommand("bun pm view react")).toBe(true);
		});
	...
	describe("destructive commands", () => {
		...
		it("blocks package manager installs", () => {
			expect(isSafeCommand("bun install")).toBe(false);
			expect(isSafeCommand("bun add react")).toBe(false);

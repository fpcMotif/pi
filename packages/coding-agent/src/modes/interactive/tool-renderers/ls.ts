...
import type { LsToolDetails, LsToolInput } from "../../../core/tools/ls.js";
...
function formatLsCall(args: LsToolInput | undefined, theme: Theme): string {
...
export const lsToolRenderer: ToolRenderer<LsToolInput, LsToolDetails | undefined> = {

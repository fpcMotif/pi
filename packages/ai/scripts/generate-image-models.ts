...
export async function fetchOpenRouterImageModels(): Promise<ImagesModel<"openrouter-images">[]> {
	try {
...
export async function main(outputPath = join(modelsPackageRoot, "src", "image-models.generated.ts")): Promise<void> {
...
/* v8 ignore start -- Direct script entrypoint; tests call main() with a temp output path. */
